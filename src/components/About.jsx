...
export default function AboutSection() {
  return (
    <section className="relative w-full py-14 px-5 md:px-20 bg-[#f4f4f4] overflow-hidden">
      ...
      <svg
        className="absolute right-0 top-0 w-64 h-64 opacity-10 z-0"
        viewBox="0 0 200 200"
      >
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
        ...
        <div>
            ...
            <div className="bg-white p-5 rounded-xl shadow-lg flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  500+ luxurious textures & finishes.
                </p>
              </div>
            </div>
            <div className="bg-white p-5 rounded-xl shadow-lg flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Sustainable production & green practices.
                </p>
              </div>
            </div>
          </div>
          ...
          <ul className="space-y-3 text-gray-700 text-base pl-5 list-disc">
            <li>
              <strong className="text-[#001f5c]">Vision:</strong> To revolutionize
              home decor with sustainable luxury fabrics.
            </li>
            <li>
              <strong className="text-[#001f5c]">Mission:</strong> Inspire design
              through innovative materials rooted in tradition.
            </li>
            <li>
              <strong className="text-[#001f5c]">Craftsmanship:</strong> Every
              yard crafted with precision, care, and design excellence.
            </li>
          </ul>
        </div>
      </div>
